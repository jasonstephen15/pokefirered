...
static const u16 sEvolutionSparklesPalData[] = INCBIN_U16("assets/graphics.bin", 0x5DC94, 0x20);
static const u32 sEvolutionSparklesTileData[] = INCBIN_U32("assets/graphics.bin", 0x5DCB4, 0x20);
