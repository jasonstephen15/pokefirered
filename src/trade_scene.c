...
static const u16 sPokeball_Pal[]                    = INCBIN_U16("assets/graphics.bin", 0x31A4C4, 0x20);
static const u8 sPokeball_Gfx[]                     = INCBIN_U8("assets/graphics.bin", 0x31A4E4, 0x600);
static const u8 sPokeballSymbol_Gfx[]               = INCBIN_U8("assets/graphics.bin", 0x31AAE4, 0x1A00); // Unused
static const u16 sCableCloseup_Map[]                = INCBIN_U16("assets/graphics.bin", 0x31C4E4, 0x800);
static const u16 sPokeballSymbol_Map[]              = INCBIN_U16("assets/graphics.bin", 0x31CCE4, 0x100);
static const u16 sUnusedPal1[]                      = INCBIN_U16("assets/graphics.bin", 0x31CDE4, 0x20);
static const u16 sGba_Pal[]                         = INCBIN_U16("assets/graphics.bin", 0x21DD44, 0x20);
static const u16 sShadowPalette[]                   = INCBIN_U16("assets/graphics.bin", 0x31CE04, 0x20);
static const u16 sBlackPalette[]                    = INCBIN_U16("assets/graphics.bin", 0x31CE24, 0x20);
static const u16 sLinkMon_Pal[]                     = INCBIN_U16("assets/graphics.bin", 0x31CE44, 0x20);
static const u8 sLinkMonGlow_Gfx[]                  = INCBIN_U8("assets/graphics.bin", 0x31CE64, 0x200);
static const u8 sLinkMonShadow_Gfx[]                = INCBIN_U8("assets/graphics.bin", 0x31D064, 0x200);
static const u8 sCableEnd_Gfx[]                     = INCBIN_U8("assets/graphics.bin", 0x31D264, 0x200);
static const u8 sGbaScreen_Gfx[]                    = INCBIN_U8("assets/graphics.bin", 0x31D464, 0x1000);
const u16 gTradeOrHatchMonShadowTilemap[]           = INCBIN_U16("assets/graphics.bin", 0x31E464, 0x1000);
static const u8 sGbaAffine_Gfx[]                    = INCBIN_U8("assets/graphics.bin", 0x31F464, 0x2800);
static const u8 sEmptyGfx[64]                       = {};
static const u8 sGbaAffineMapCable[]                = INCBIN_U8("assets/graphics.bin", 0x321C64, 0x100);
static const u8 sGbaAffineMapWireless[]             = INCBIN_U8("assets/graphics.bin", 0x321D64, 0x100);
static const u16 sGbaMapWireless[]                  = INCBIN_U16("assets/graphics.bin", 0x321E64, 0x1000);
static const u16 sGbaMapCable[]                     = INCBIN_U16("assets/graphics.bin", 0x322E64, 0x1000);
static const u32 sWirelessCloseup_Map[]             = INCBIN_U32("assets/graphics.bin", 0x323E64, 0x100);
static const u16 sWirelessSignalAnimPals_Outbound[] = INCBIN_U16("assets/graphics.bin", 0x323F64, 0x200);
static const u16 sWirelessSignalAnimPals_Inbound[]  = INCBIN_U16("assets/graphics.bin", 0x324164, 0x200);
static const u16 sWirelessSignalAnimPals_Off[]      = INCBIN_U16("assets/graphics.bin", 0x31CE24, 0x20);
static const u32 sWirelessSignal4bpp[]              = INCBIN_U32("assets/graphics.bin", 0x324364, 0x690);
static const u32 sWirelessSignalTilemap[]           = INCBIN_U32("assets/graphics.bin", 0x3249F4, 0x6F4);
...
// ===== BEGIN src/data/ingame_trades.h =====
