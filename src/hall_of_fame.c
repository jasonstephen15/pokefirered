...
static const u16 sHallOfFame_Pal[] = INCBIN_U16("assets/graphics.bin", 0x21FE44, 0x20);
static const u32 sHallOfFame_Gfx[] = INCBIN_U32("assets/graphics.bin", 0x21FE64, 0x1CC);
